...
<h1>By {{$product->user->name}}
{{$product->user->surname}}</h1>
												...
												<div id="product-carousel" class="product-listing">
													...
													<div class="product  item first ">
														...
														<article>
															...
															<figure>
																<a href="#">
																	<img src="{{asset('images/'.$p->url)}}" class="img-responsive" alt="T_7_front">
																</a>
																<figcaption><span class="amount">{{$product->price}}</span></figcaption>
															</figure>
