												...
												<table class="table checkout-table">
													...
													<tr>
														<td class="product-name-col">
															<p class="product-price-special">{{$c->product['name']}}</p>
														</td>
														
															{{-- <figure>
																<a href="#"><img src="{{asset('images/'.$c['product']['photo']['url'])}}"></a>
															</figure> --}}
														...
														{{--  <td>
															...
															<div class="custom-quantity-input">
																<input type="text" name="quantity" value="{{$c['product']['count']}}">
															</div>
														</td>  --}}
														<td class="product-total-col">

                                                                    <span class="product-price-special">{{$c['total']}}
                </span>
														</td> 
													 <td>
														 <a href="{{url('order/details/' . $c->id)}}" style="text-decoration: none;color:green">Details</a>
														</td> 
													</tr>
					@endforeach
													<tr class="merged">
